 ...
 * Generated for Laravel 5.8.38 on 2020-07-26 19:48:51.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
         ...
         * @static 
         */ 
        public static function clearGuardsCache()
        {
                        /** @var \SMartins\PassportMultiauth\Auth\AuthManager $instance */
                        return $instance->clearGuardsCache();
        }
         ...
         * @param string $driver
         * @param callable $callback
         * @return \SMartins\PassportMultiauth\Auth\AuthManager 
         * @static 
         */ 
